...
После пуша в GitHub:
```bash
cd ~/deploy-config/services/memdb-core
...
| Обновить submodule | `cd ~/deploy-config/services/memdb-core && git pull` |
...
**Все изменения делайте в `/home/user/MemDB`**
