# src/memdb/mem_scheduler/utils/metrics.py
import time
...
TASKS_ENQUEUED_TOTAL = Counter(
    "memdb_scheduler_tasks_enqueued_total",
    "Total number of tasks enqueued",
    ["user_id", "task_type"],
)

TASKS_DEQUEUED_TOTAL = Counter(
    "memdb_scheduler_tasks_dequeued_total",
    "Total number of tasks dequeued",
    ["user_id", "task_type"],
)

TASK_DURATION_SECONDS = Summary(
    "memdb_scheduler_task_duration_seconds",
    "Task processing duration in seconds",
    ["user_id", "task_type"],
)

TASK_WAIT_DURATION_SECONDS = Summary(
    "memdb_scheduler_task_wait_duration_seconds",
    "Task waiting duration in seconds",
    ["user_id", "task_type"],
)

TASKS_FAILED_TOTAL = Counter(
    "memdb_scheduler_tasks_failed_total",
    "Total number of failed tasks",
    ["user_id", "task_type", "error_type"],
)

TASKS_COMPLETED_TOTAL = Counter(
    "memdb_scheduler_tasks_completed_total",
    "Total number of successfully completed tasks",
    ["user_id", "task_type"],
)

QUEUE_LENGTH = Gauge(
    "memdb_scheduler_queue_length", "Current length of the task queue", ["user_id"]
)

INTERNAL_SPAN_DURATION = Histogram(
    "memdb_scheduler_internal_span_duration_seconds",
