...
from memdb.mem_scheduler.orm_modules.base_model import DatabaseError
from memdb.mem_scheduler.schemas.api_schemas import (
...
class APIRedisDBManager:
    ...
    def merge_items(
        ...
        from memdb.mem_scheduler.schemas.api_schemas import APIMemoryHistoryEntryItem
    ...
    def load_redis_engine_from_env(env_file_path: str | None = None) -> Any:
        ...
        redis_host = os.getenv("REDIS_HOST") or os.getenv("MEMDBSCHEDULER_REDIS_HOST")
        redis_port_str = os.getenv("REDIS_PORT") or os.getenv("MEMDBSCHEDULER_REDIS_PORT")
        redis_db_str = os.getenv("REDIS_DB") or os.getenv("MEMDBSCHEDULER_REDIS_DB")
        redis_password = os.getenv("REDIS_PASSWORD") or os.getenv("MEMDBSCHEDULER_REDIS_PASSWORD")
        ...
        socket_timeout = os.getenv(
            "REDIS_SOCKET_TIMEOUT", os.getenv("MEMDBSCHEDULER_REDIS_TIMEOUT", None)
        )
        socket_connect_timeout = os.getenv(
            "REDIS_SOCKET_CONNECT_TIMEOUT", os.getenv("MEMDBSCHEDULER_REDIS_CONNECT_TIMEOUT", None)
        )
