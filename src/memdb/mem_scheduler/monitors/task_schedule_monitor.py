...
class TaskScheduleMonitor:
    ...
    Initialize with the underlying `memdb_message_queue` implementation
    ...
    def __init__(
        self,
        memdb_message_queue: SchedulerRedisQueue | SchedulerLocalQueue,
        dispatcher: object | None = None,
        get_status_parallel: bool = False,
    ) -> None:
        self.queue = memdb_message_queue
