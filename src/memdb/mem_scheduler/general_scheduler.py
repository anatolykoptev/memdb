...
from memdb.mem_scheduler.schemas.monitor_schemas import QueryMonitorItem
...
from memdb.mem_scheduler.utils.misc_utils import (
...
class GeneralScheduler(BaseScheduler):
    ...
    def _process_memories_with_reader(
        ...
        kb_log_content: list[dict] = []
        try:
            # Get the mem_reader from the parent MemDBCore
            ...
            from memdb.memories.textual.tree_text_memory.organize.manager import (
