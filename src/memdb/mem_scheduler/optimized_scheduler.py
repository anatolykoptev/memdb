...
from memdb.configs.mem_scheduler import GeneralSchedulerConfig
...
from memdb.mem_scheduler.general_modules.api_misc import SchedulerAPIModule
...
from memdb.mem_scheduler.utils.api_utils import format_textual_memory_item
...
class OptimizedScheduler(GeneralScheduler):
    ...
    def submit_memory_history_async_task(
        ...
        # Submit async task
        self.memdb_message_queue.submit_messages([message])
