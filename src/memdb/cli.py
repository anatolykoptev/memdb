"""
MemDB CLI Tool
This script provides command-line interface for MemDB operations.
"""
...
def export_openapi(output: str) -> bool:
    ...
    from memdb.api.server_api import app
...
def download_examples(dest: str) -> bool:
    ...
    """Download examples from the MemDB repository."""
    zip_url = "https://github.com/MemDBai/MemDB/archive/refs/heads/main.zip"
    ...
    try:
        ...
        with zipfile.ZipFile(BytesIO(response.content)) as z:
            ...
            for file in z.namelist():
                if "MemDB-main/examples/" in file and not file.endswith("/"):
                    # Remove the prefix and extract to dest
                    relative_path = file.replace("MemDB-main/examples/", "")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="memdb",
        description="MemDB Command Line Interface",
    )
