...
class SQLiteUserManagerConfig(BaseUserManagerConfig):
    ...
    db_path: str | None = Field(
        default=None,
        description="Path to SQLite database file. If None, uses default path in MEMDB_DIR",
    )
...
class MySQLUserManagerConfig(BaseUserManagerConfig):
    ...
    database: str = Field(default="memdb_users", description="MySQL database name")
...
class RedisUserManagerConfig(BaseUserManagerConfig):
    ...
    database: str = Field(default="memdb_users", description="Redis database name")
