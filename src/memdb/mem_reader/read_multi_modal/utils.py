...
from memdb.types.openai_chat_completion_types import (
...
try:
    from memdb.chunkers.charactertext_chunker import CharacterTextChunker
    from memdb.chunkers.markdown_chunker import MarkdownChunker
    ...
    from memdb.chunkers.simple_chunker import SimpleTextSplitter
...
def detect_lang(text):
    ...
    try:
        ...
        # remove URLs to prevent dilution of Chinese character ratio
