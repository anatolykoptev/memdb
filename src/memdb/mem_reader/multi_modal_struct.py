...
from memdb.configs.mem_reader import MultiModalStructMemReaderConfig
from memdb.context.context import ContextThreadPoolExecutor
from memdb.mem_reader.read_multi_modal import MultiModalParser, detect_lang
from memdb.mem_reader.read_multi_modal.base import _derive_key
from memdb.mem_reader.read_skill_memory.process_skill_memory import process_skill_memory_fine
from memdb.mem_reader.simple_struct import PROMPT_DICT, SimpleStructMemReader
...
from memdb.templates.mem_reader_prompts import MEMORY_MERGE_PROMPT_EN, MEMORY_MERGE_PROMPT_ZH
from memdb.templates.tool_mem_prompts import TOOL_TRAJECTORY_PROMPT_EN, TOOL_TRAJECTORY_PROMPT_ZH
from memdb.types import MessagesType
    ...
    def _split_large_memory_item(
        ...
        try:
            ...
            def _create_chunk_item(chunk):
                # Chunk objects have a 'text' attribute; handle raw strings too
