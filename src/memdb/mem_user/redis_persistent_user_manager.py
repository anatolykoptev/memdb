"""Redis-based persistent user management system for MemDB with configuration storage.
...
class RedisPersistentUserManager:
    ...
    def save_user_config(self, user_id: str, config: MemDBConfig) -> bool:
        ...
        Args:
            user_id (str): User ID.
            config (MemDBConfig): User's MemDB configuration.
    ...
    def get_user_config(self, user_id: str) -> dict | None:
        ...
        Returns:
            MemDBConfig | None: User's configuration object, or None if not found.
        """
        try:
            ...
            # Parse JSON and create MemDBConfig object
