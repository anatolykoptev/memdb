...
from memdb.configs.graph_db import NebulaGraphDBConfig
...
class NebulaGraphDB(BaseGraphDB):
    ...
    def _ensure_space_exists(cls, tmp_client, cfg):
        ...
        try:
            ...
            if db_name not in existing:
                tmp_client.execute(f"CREATE GRAPH IF NOT EXISTS `{db_name}` TYPED MemDBBgeM3Type")
    ...
    def _ensure_database_exists(self):
        graph_type_name = "MemDBBgeM3Type"
