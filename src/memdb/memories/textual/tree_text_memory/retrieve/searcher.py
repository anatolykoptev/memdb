...
from memdb.memories.textual.item import SearchedTreeNodeTextualMemoryMetadata, TextualMemoryItem
...
from memdb.templates.mem_search_prompts import (
    COT_PROMPT,
    COT_PROMPT_ZH,
    SIMPLE_COT_PROMPT,
...
class Searcher:
    ...
    def _retrieve_from_memcubes(
        self, query, parsed_goal, query_embedding, top_k, cube_name="memdb_cube01"
    ):
        """Retrieve and rerank from LongTermMemory and UserMemory"""
