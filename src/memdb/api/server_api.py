...
from memdb.api.routers.server_router import router as server_router
...
app = FastAPI(
    title="MemDB Server REST APIs",
    description="A REST API for managing multiple users with MemDB Server.",
    version="1.0.1",
)
...
if __name__ == "__main__":
    ...
    uvicorn.run("memdb.api.server_api:app", host="0.0.0.0", port=args.port, workers=args.workers)
