...
from memdb.api.product_models import (
    MemDBAddFeedBackResponse,
    MemDBAddKnowledgebaseFileResponse,
    MemDBAddResponse,
    MemDBChatResponse,
    MemDBCreateKnowledgebaseResponse,
    MemDBDeleteKnowledgebaseResponse,
    MemDBDeleteMemoryResponse,
    MemDBGetKnowledgebaseFileResponse,
    MemDBGetMemoryResponse,
    MemDBGetMessagesResponse,
    MemDBGetTaskStatusResponse,
    MemDBSearchResponse,
)
...
class MemDBClient:
    ...
    def __init__(self, api_key: str | None = None, base_url: str | None = None):
        ...
        if not api_key:
            raise ValueError("MemDB API key is required")
    ...
    def get_message(
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBGetMessagesResponse(**response_data)
    ...
    def add_message(
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBAddResponse(**response_data)
            except Exception as e:
    ...
    def search_memory(
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBSearchResponse(**response_data)
            except Exception as e:
    ...
    def get_memory(
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBGetMemoryResponse(**response_data)
            except Exception as e:
    ...
    def create_knowledgebase(
    ...
    ) -> MemDBCreateKnowledgebaseResponse | None:
        """
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBCreateKnowledgebaseResponse(**response_data)
            except Exception as e:
    ...
    def delete_knowledgebase(
    ...
    ) -> MemDBDeleteKnowledgebaseResponse | None:
        """
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBDeleteKnowledgebaseResponse(**response_data)
            except Exception as e:
    ...
    def add_knowledgebase_file_json(
    ...
    ) -> MemDBAddKnowledgebaseFileResponse | None:
        """
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBAddKnowledgebaseFileResponse(**response_data)
            except Exception as e:
    ...
    def get_knowledgebase_file(
        self, file_ids: list[str]
    ) -> MemDBGetKnowledgebaseFileResponse | None:
        """
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBGetKnowledgebaseFileResponse(**response_data)
            except Exception as e:
                logger.error(f"Failed to get knowledgebase-file (retry {retry + 1}/3): {e}")
                if retry == MAX_RETRY_COUNT - 1:
                    raise

    def get_task_status(self, task_id: str) -> MemDBGetTaskStatusResponse | None:
        """
        get task status
        """
        # Validate required parameters
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBGetTaskStatusResponse(**response_data)
            except Exception as e:
    ...
    def add_feedback(
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBAddFeedBackResponse(**response_data)
            except Exception as e:
    ...
    def delete_memory(
    ...
    ) -> MemDBDeleteMemoryResponse | None:
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBDeleteMemoryResponse(**response_data)
            except Exception as e:
    ...
    def chat(
        ...
        for retry in range(MAX_RETRY_COUNT):
            try:
                ...
                return MemDBChatResponse(**response_data)
            except Exception as e:
