"""
Base handler for MemDB API handlers.
...
from memdb.memories.textual.tree_text_memory.retrieve.advanced_searcher import AdvancedSearcher
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            mos_server: MemDB server instance
