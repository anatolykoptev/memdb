"""
Server API Router for MemDB (Class-based handlers version).
...
from memdb.api import handlers
from memdb.api.handlers.add_handler import AddHandler
from memdb.api.handlers.base_handler import HandlerDependencies
from memdb.api.handlers.chat_handler import ChatHandler
from memdb.api.handlers.feedback_handler import FeedbackHandler
...
from memdb.mem_scheduler.base_scheduler import BaseScheduler
...
@router.post("/chat/stream", summary="Chat with MemDB")
...
@router.post("/chat/stream/playground", summary="Chat with MemDB playground")
