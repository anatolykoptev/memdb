...
7. Temporal scope: If the query references a specific time period (e.g., "last week", "yesterday", "recently", "прошлый месяц"), set temporal_scope to one of: "last_24h", "last_7_days", "last_30_days", "last_90_days". If no temporal intent is detected, set to null.
...
input query:
{
  ...
  "memories": ["...", "...", ...],
  "temporal_scope": "last_24h" | "last_7_days" | "last_30_days" | "last_90_days" | null
}
"""
