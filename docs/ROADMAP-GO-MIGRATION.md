...
| Roadmap | Что внутри |
|---------|-----------|
| **[ROADMAP-SEARCH.md](ROADMAP-SEARCH.md)** | D1-D11 retrieval features (multi-hop, CoT decomp, staged retrieval, post-retrieval enhancement, structural edges), LoCoMo benchmarks, Memobase port targets |
| **[ROADMAP-ADD-PIPELINE.md](ROADMAP-ADD-PIPELINE.md)** | Pronoun/temporal/third-person resolution в extraction, structured preference taxonomy, hierarchical reorganizer (D3) |
| **[ROADMAP-FEATURES.md](ROADMAP-FEATURES.md)** | Image Memory, MemCube sharing, новые API surface |
