...
>
> **Статус на v2.0.0 (апрель 2026)**: LoCoMo hit@20 = **0.700** — выше Mem0 (0.65) и MemOS (0.60), на уровне Claude-3-Opus+RAG (0.72). Полный Phase D quality-stack shipped — см. [docs/backlog/search.md](../backlog/search.md), [ROADMAP-GO-MIGRATION.md](../ROADMAP-GO-MIGRATION.md), [evaluation/locomo/MILESTONES.md](../../evaluation/locomo/MILESTONES.md). LLM cost optimization часть ниже — отдельный long-term трек, не перекрывается с v2.0.0.
