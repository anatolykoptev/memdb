...
**Files:**
- Create: `/home/user/deploy/server-config/models/multilingual-e5-small/` (directory)

**Step 1: Download model from HuggingFace**

```bash
# From Xenova (same source as current e5-large quantized model)
mkdir -p /home/user/deploy/server-config/models/multilingual-e5-small
cd /home/user/deploy/server-config/models/multilingual-e5-small
...
```bash
ls -lh /home/user/deploy/server-config/models/multilingual-e5-small/
```
...
In `/home/user/deploy/server-config/docker-compose.yml`, add to memdb-go volumes:

```yaml
- /home/user/deploy/server-config/models/multilingual-e5-small:/models-small:ro
```
...
```bash
cd /home/user/src/MemDB/memdb-go && go build ./...
```
