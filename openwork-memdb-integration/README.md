...
Openwork can connect to MemDB to provide long-term memory. When a MemDB API key is set, relevant memories are injected into the system prompt and new memories are saved after tasks finish. Learn more in the MemDB docs: https://github.com/MemDBai/MemDB
